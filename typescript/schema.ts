...
//     readonly ratable : Ratable<Type> = new Ratable<Type>
//   ){

//   }
// }
// export type GrapevineRatings<Types = (string | kindnumber)[]> = 
//   GrapevineRating<keyof Types> | never

// /**
//  * A record of Ratings, indexed by a UID for the ratable event 
//  */
// export type GrapevineRatingsRecord<Types = (string | number)[]> = 
//   Record<RatableUids<Types>,GrapevineRatings<Types>>
...
//   Record<pubkey,GrapevineRatingsRecord<Types>>
...
// export type RatableClass<Type = string | kindnumber> = 
...
//   never
// export type RatableClasses<Types = (string | kindnumber)[]> = 
// RatableClass<keyof Types> | never


// export type RatableUid<Type> = 
...
//   never
// export type RatableUids<Types = (string | kindnumber)[]> = 
//   RatableUid<keyof Types> | never

// export type RatableScore<Type> = 
//   RatableClass<Type> extends "PubkeyList" ? 0 | 1 : 
//   RatableClass<Type> extends string ? percent :
//   never

// export type RatableConfidence<Type> = 
//   RatableClass<Type> extends "PubkeyList" ? 0 | 1 :   
//   RatableClass<Type> extends string ? percent :
//   never

// export type RatableContext<Type> = string;
